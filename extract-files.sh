...
adb pull /system/etc/wifi/sdio-g-cdc-full11n-reclaim-roml-wme-idsup.bin ../../../vendor/$MANUFACTURER/$DEVICE/proprietary/sdio-g-cdc-full11n-reclaim-roml-wme-idsup.bin
